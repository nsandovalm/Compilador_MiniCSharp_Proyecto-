...
public interface IMiniCSharpParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitWhereStatementAST([NotNull] MiniCSharpParser.WhereStatementASTContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitPuntoComaStatementAST([NotNull] MiniCSharpParser.PuntoComaStatementASTContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitTrueFalseFactorAST([NotNull] MiniCSharpParser.TrueFalseFactorASTContext context);
	/// <summary>
