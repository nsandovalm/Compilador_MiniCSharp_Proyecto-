...
namespace Editor
{
  ...
  /// </summary>
  public class MyErrorSpanish : DefaultErrorStrategy
  {
    /// <summary>
    ...
    {
      string message = "Error de entrada " + this.GetTokenErrorDisplay(e.OffendingToken) + " esperando " + e.GetExpectedTokens().ToString(recognizer.Vocabulary);
      this.NotifyErrorListeners(recognizer, message, (RecognitionException) e);
    }
    ...
    protected internal virtual void ReportMissingToken(Parser recognizer)
    {
      ...
      this.BeginErrorCondition(recognizer);
      IToken currentToken = recognizer.CurrentToken;
      string msg = "Desaparecido " + this.GetExpectedTokens(recognizer).ToString(recognizer.Vocabulary) + " en " + this.GetTokenErrorDisplay(currentToken);
      recognizer.NotifyErrorListeners(currentToken, msg, (RecognitionException) null);
    }
